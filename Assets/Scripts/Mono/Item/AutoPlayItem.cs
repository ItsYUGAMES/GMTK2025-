...
/// <summary>
/// 自动演奏道具 - 可以选择AD或JL控制器进行自动演奏 (20金币)
/// </summary>
...
public class AutoPlayItem : ItemEffect
{
    [Header("道具效果")]
    [Range(0.8f, 1.0f)]
    public float autoPlayAccuracy = 0.95f;  // 自动游玩的准确率
    ...
    public override void OnPurchase()
    {
        ...
        Debug.Log($"已为 {selectedController.keyConfigPrefix} 控制器启用自动演奏模式");
    }
    ...
    private RhythmKeyControllerBase GetTargetController()
    {
        ...
        {
            Debug.LogWarning("没有可用的控制器（都已启用自动模式或未找到）");
            return null;
        }
